...
cp native/build-aarch64/src/Release/DalorianScape.exe build/win-aarch64/
cp build/libs/DalorianScape.jar build/win-aarch64/
...
echo DalorianScape.exe aarch64 sha256sum
sha256sum build/win-aarch64/DalorianScape.exe

dumpbin //HEADERS build/win-aarch64/DalorianScape.exe
